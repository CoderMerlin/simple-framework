...
public class ClassUtil {
    ...
    public static Set<Class<?>> extractPackageClass(String packageName) {
        ...
        //TODO 此处可以增加处理其他类型的资源
        return classSet;
    }

    /**
     * 递归获取目标package里面的所有class 文件（包括子package里面的class文件）
        ...
        File[] files = fileSource.listFiles(new FileFilter() {
            ...
            public boolean accept(File file) {
                if(file.isDirectory()){
                    ...
                    if(absoluteFilePath.endsWith(CLASS_END)){
                        //若是class文件，则直接加载
            ...
            private void addToClassSet(String absoluteFilePath) {
                ...
                //如：E:\Github\simple-framework\target\classes\com\cp\entity\DTO\MainPageInfoDTO.class
                //需要弄成com.cp.entity.DTO.MainPageInfoDTO
    ...
    public static void main(String[] args) {
        extractPackageClass("com.cp.entity");
    }
}
